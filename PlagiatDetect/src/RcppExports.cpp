...
RcppExport SEXP _PlagiatDetect_cpp_Levenstein(SEXP str1SEXP, SEXP str2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::string >::type str1(str1SEXP);
    Rcpp::traits::input_parameter< std::string >::type str2(str2SEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_Levenstein(str1, str2));
    return rcpp_result_gen;
END_RCPP
}
// cpp_plagiat
double cpp_plagiat(std::string str1, std::string str2);
RcppExport SEXP _PlagiatDetect_cpp_plagiat(SEXP str1SEXP, SEXP str2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::string >::type str1(str1SEXP);
    Rcpp::traits::input_parameter< std::string >::type str2(str2SEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_plagiat(str1, str2));
    return rcpp_result_gen;
END_RCPP
}
// Scores_matrixCpp
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_PlagiatDetect_cpp_Levenstein", (DL_FUNC) &_PlagiatDetect_cpp_Levenstein, 2},
    {"_PlagiatDetect_cpp_plagiat", (DL_FUNC) &_PlagiatDetect_cpp_plagiat, 2},
