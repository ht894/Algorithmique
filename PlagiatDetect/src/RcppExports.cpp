...
RcppExport SEXP _PlagiatDetect_cpp_lev_naif(SEXP texte1SEXP, SEXP texte2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(cpp_lev_naif(texte1, texte2));
    return rcpp_result_gen;
END_RCPP
}
...
RcppExport SEXP _PlagiatDetect_cpp_scores_matrix(SEXP str1SEXP, SEXP str2SEXP, SEXP gap_costSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::string >::type str1(str1SEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(cpp_scores_matrix(str1, str2, gap_cost));
    return rcpp_result_gen;
END_RCPP
}
// cpp_Traceback
std::string cpp_Traceback(NumericMatrix scores_matrix, std::string str1);
RcppExport SEXP _PlagiatDetect_cpp_Traceback(SEXP scores_matrixSEXP, SEXP str1SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type scores_matrix(scores_matrixSEXP);
    Rcpp::traits::input_parameter< std::string >::type str1(str1SEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_Traceback(scores_matrix, str1));
    return rcpp_result_gen;
END_RCPP
}
// cpp_Smith_Waterman
List cpp_Smith_Waterman(std::string texte1, std::string texte2, int gap_cost);
RcppExport SEXP _PlagiatDetect_cpp_Smith_Waterman(SEXP texte1SEXP, SEXP texte2SEXP, SEXP gap_costSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::string >::type texte1(texte1SEXP);
    Rcpp::traits::input_parameter< std::string >::type texte2(texte2SEXP);
    Rcpp::traits::input_parameter< int >::type gap_cost(gap_costSEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_Smith_Waterman(texte1, texte2, gap_cost));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_PlagiatDetect_cpp_lev_naif", (DL_FUNC) &_PlagiatDetect_cpp_lev_naif, 2},
    {"_PlagiatDetect_cpp_plagiat_Levenshtein", (DL_FUNC) &_PlagiatDetect_cpp_plagiat_Levenshtein, 2},
    {"_PlagiatDetect_cpp_scores_matrix", (DL_FUNC) &_PlagiatDetect_cpp_scores_matrix, 3},
    {"_PlagiatDetect_cpp_Traceback", (DL_FUNC) &_PlagiatDetect_cpp_Traceback, 2},
    {"_PlagiatDetect_cpp_Smith_Waterman", (DL_FUNC) &_PlagiatDetect_cpp_Smith_Waterman, 3},
    {NULL, NULL, 0}
};
